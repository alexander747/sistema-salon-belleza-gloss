# Categorías CRUD Specification

## Purpose

Define CRUD operations for service categories (categorías de servicio) within a salon. Categories organize servicios and provide hierarchical structure to the catalog.
